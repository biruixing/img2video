...
if __name__ == '__main__':
  ...
  frame_path='/host/Desktop/Ultra-Fast-Lane-Detection/tengdun/2255/'
  video_path='/host/Desktop/Ultra-Fast-Lane-Detection/tengdun/2255landing.avi'

  #unlock_movie(PATH_TO_MOVIES)  # 视频转图片
  jpg_to_video(frame_path,video_path, 17)  # 图片转视频